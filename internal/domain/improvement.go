...
type ImprovementEvent struct { // nosemgrep: first-class-collection.raw-slice-field-domain-go -- JSON/YAML wire format; FCC wrapping would break D-Mail serialization [permanent]
