...
type PolicyEngine struct { // nosemgrep: naming.ambiguous-suffix-struct-go -- PolicyEngine suffix is cross-tool architecture (all 4 tools share this name) [permanent]
