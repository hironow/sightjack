...
func RunScan(ctx context.Context, cmd domain.RunScanCommand, cfg *sightjack.Config, baseDir, sessionID string, dryRun bool, streamOut io.Writer, logger *domain.Logger) (*sightjack.ScanResult, error) {
